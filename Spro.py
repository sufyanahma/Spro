...
logo='''
   ...
   SSSSS     PPPPPP     RRRRRR      OOOOO  
  SS         PP   PP    RR   RR    OO   OO 
   SSSSS     PPPPPP     RRRRRR     OO   OO 
       SS    PP         RR  RR     OO   OO 
   SSSSS     PP         RR   RR     OOOO0                                                                    
--------------------------------------------------
 Owner       : SuFyaN AhMad
 Facebook    : www.facebook.com/sufyanshabqadry
...
def action():
	...
	if chb =="":
	    ...
	    psb("ok")
	    psb("ok")
	    psb("Congratulations Spro Tool Has Been Updated Successfully")
	    time.sleep(2)
	    menu()
	elif chb =="7":
...
def choice_action():
	...
	if bch =="":
		...
		print (logo)
		idt = raw_input("[ok] Enter ID : ")
		pass1=raw_input(" Put Name + Pass 1 : ")
		pass2=raw_input(" Put Name + Pass 2 : ")
		pass3=raw_input(" Put Name + Pass 3 : ")
		pass4=raw_input(" Put Name + Pass 4 : ")
		pass5=raw_input(" Put Name + Pass 5 : ")
